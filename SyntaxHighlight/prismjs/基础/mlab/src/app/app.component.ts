 ...
 *
 * 语法高亮样式
 * https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+apacheconf+c+cpp+docker+git+go+groovy+http+java+json+kotlin+markdown+lua+makefile+nginx+objectivec+sql+properties+python+typescript+swift+yaml+wasm
 */
@Component({
  selector: 'app-root',
